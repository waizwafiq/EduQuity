...
function RequiredModal({ open, onClose, children }) {
  return (
    <div
      onClick={onClose}
    ...
    >
      <div
        ...
        className={`bg-white rounded-xl shadow p-6 transition-all flex justify-center items-center ${open ? "scale-100 opacity-100" : "scale-125 opacity-0"
          }`}
