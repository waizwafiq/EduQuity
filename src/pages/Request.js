...
function Request({ themeStyles }) {
    ...
    return (
        <div className="min-h-screen" style={{ ...themeStyles, backgroundColor: colors.BGGrey }}>
            ...
            <div className="mx-14 text-center grid grid-cols-2 gap-x-3 md:grid-cols-1 lg:grid-cols-2" style={{ height: '' }}>
                <iframe
                ...
                <div style={{ backgroundColor: colors.BGCardGrey, borderRadius: '20px' }}>
                    ...
                    <div className='bg-white relative mx-8 rounded flex items-center grid grid-cols-5' style={{ top: '-85px', height: '145px', borderRadius: '20px' }}>
                        <div className="border-r-2 border-black border-opacity-50">
                            <img src={logo_school} style={{ height: '120px' }} className="mx-5" alt="School Logo" />
                        </div>

                        <div className='col-span-3 text-left px-4 grid grid-rows-3'>
                            <div>
